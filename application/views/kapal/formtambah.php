      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary box-solid">
            ...
            <!-- /.box-header -->
            <form action="<?=base_url()?>kapal/prosessimpan" role="form" method="post" class="form-horizontal">
              <div class="box-body">
               <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Kode Kapal</label>
                  <input type="text" class="form-control" readonly value="<?=$kodekapal?>" name="kapalkodekapal" placeholder="Kode kapal">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama kapal</label>
                  <input type="text" class="form-control" id="namakapal" required="" name="namakapal" placeholder="Nama kapal">
                </div>
                <div class="form-group">
